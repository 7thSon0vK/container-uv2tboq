...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uv2tboq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uv2tboq.containers.anotherwebservice.com/
...
```
git clone git@github.com:7thSon0vK/container-uv2tboq.git
cd container-uv2tboq
```
...
```
docker attach container-uv2tboq
```
